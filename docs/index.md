...
features:
  ...
  - icon: 🧭
    ...
    details: From the first message, each agent gets a short briefing about its surroundings – that it's in Obsidian, that your replies render links, math, and diagrams, and that it can work with your notes when the chat runs in your vault. It acts native out of the box, and you choose exactly what it's told.
  - icon: 🛡️
