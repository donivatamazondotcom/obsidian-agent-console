...
**Reset to defaults** turns all four switches back on, clears your vault context and any hand-edited prompt, and returns to the switches — handy if you've experimented and want the original behavior back. If you've typed your own vault context or edited the full prompt, it asks you to confirm first so you don't lose that text by accident.
