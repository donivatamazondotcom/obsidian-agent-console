...
<p align="center">
  <img src="/images/settings-working-directory.webp" alt="Agent Console settings showing the Default working directory option that sets where new chats start" />
</p>
