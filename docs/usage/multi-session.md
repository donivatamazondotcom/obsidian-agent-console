...
Agent Console supports opening multiple chat views, each with its own:
...
Configure where new chat views open in **Settings → Agent Console → Display → Chat view location**:
