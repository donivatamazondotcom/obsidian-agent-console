...
<p align="center">
  <img src="/images/settings-agent-page.webp" alt="Claude Code settings sub-page with API key, path and Auto-detect, arguments, and environment variables" />
</p>
...
2. Enter the API key in **Settings → Agent Console → Claude Code → API key**
